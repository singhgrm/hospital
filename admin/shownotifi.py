...
#rgb
{
min-heightheight:300px;
width:600px;
margin:50px;
margin-left:350px;
border:6px solid #31635a;
box-shadow:5px 6px 6px 6px white;
...
<center>
<h5>notification</h5>
<form action="noticode.py" method="post">
<table border="3" cellspacing="3" cellpadding="3" style="border:2px solid white;">
<tr>
<td>Enter the notification : </td>
</tr>
<tr>
<td>
<textarea name="noti">
...
<p></p>
<center>
<table border="3" cellpadding="3" cellspacing="3" style="border:3px solid white;">
<tr>
<th> ID </th>
<th> NOTIFICATION </th>
<th> DATE </th>
...
query="select * from pt_notification"
cur=con.cursor()
cur.execute(query)
res=cur.fetchall()
for row in res:
