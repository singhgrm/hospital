...
<div id="rgb">
<div id="con">
<form action="pt_querycode.py" method="post">
<center>
<table>
<h3 style="color:#ffff80;">WRITE YOUR QUERY</h3>
<tr>
<td class="st1">Name:</td>
<td><input type="text" name="namee" class="st2"/></td>
</tr>
<tr>
...
<tr>
<td class="st1">Query:</td>
<td><textarea name="query" class="st2">
</textarea>
</td>
</tr>
<tr>
